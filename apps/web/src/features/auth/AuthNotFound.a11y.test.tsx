/**
 * Accessibility tests for the AuthNotFound screen (task 18.3).
 *
 * These assert `jest-axe` reports no accessibility violations on the fully
 * rendered AuthNotFound screen in BOTH the dark and light themes
 * (Requirement 14.8).
 *
 ...
 * install a small `matchMedia` stub, mirroring the sibling auth a11y tests, to
...
describe('AuthNotFound accessibility', () => {
