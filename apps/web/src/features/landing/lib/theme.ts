/**
 * Theme surface for the marketing landing page.
 *
 ...
 * the auth feature, and outside the app shell — and all three features import it
 * from there (Requirements 12.13, 15.7). What used to be a second copy of the
 * dark-mode-first resolution rule here is now a re-export, so the landing page,
 * the auth screens, and the shell can never disagree about the resolved Theme.
 *
